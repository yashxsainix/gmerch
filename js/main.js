          ...
          <nav class="glass-nav rounded-[2rem] px-4 py-3 md:px-6" aria-label="Main navigation">
            <div class="flex items-center justify-between gap-4">
              ...
              <div class="hidden items-center gap-2 md:flex">
                ...
                ${navLink('Gallery', 'gallery.html', currentPage === 'gallery')}
          ...
          <div class="grid gap-8 rounded-[2rem] bg-white/70 p-6 shadow-xl md:grid-cols-[1.3fr_1fr_1fr] md:p-8">
            ...
            <div>
              ...
              <ul class="space-y-2 text-sm text-slate-600">
                ...
                <li><a href="gallery.html" class="nav-link inline-flex p-0 hover:bg-transparent">Brand ambassadors</a></li>
            ...
            <div>
              ...
              <div class="flex flex-wrap items-center gap-3">
                <a href="https://www.instagram.com/pawdrippets/?hl=en" target="_blank" rel="noopener noreferrer" class="social-pill" aria-label="Visit GMerch on Instagram">
                  <svg class="h-5 w-5 text-pink-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <rect x="3" y="3" width="18" height="18" rx="5" ry="5"></rect>
                    <path d="M16 11.37a4 4 0 1 1-1.37-1.37 4 4 0 0 1 1.37 1.37z"></path>
                    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
                  </svg>
                </a>
                <a href="https://www.instagram.com/pawdrippets/?hl=en" target="_blank" rel="noopener noreferrer" class="text-sm font-semibold text-pink-500 underline-offset-4 hover:underline">@pawdrippets</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="mobile-drawer" class="drawer-shell" aria-hidden="true">
        ...
        <aside class="mobile-drawer soft-card rounded-l-[2rem] bg-white/92">
          ...
          <div class="grid gap-3">
            ...
            ${mobileNavLink('Gallery', 'gallery.html')}
...
function initGalleryLightbox() {
  ...
  document.addEventListener('click', (event) => {
    ...
    if (trigger) {
      ...
      const text = trigger.getAttribute('data-gallery-caption') || '';
...
function closeGalleryLightbox() {
  ...
  if (image) image.src = '';
  if (!document.getElementById('blog-modal')?.classList.contains('active') && !document.getElementById('cart-modal')?.classList.contains('active')) {
    document.body.style.overflow = '';
  }
}
